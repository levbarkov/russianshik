...
<div class="popular__controls">
    ...
    <button class="btn btn-default popular__controls-btn" data-filter=".category-18">Аксессуары</button>
    <button class="btn btn-default popular__controls-btn" data-filter=".category-19">Меховые шкурки</button>
</div>

<div class="popular__list">
						<div class="popular__list-item-col category-18">
				<div class="popular__list-item">
					<a href="/catalog/accessories/shapka_norkovaya/" class="popular__list-item-img-wrapper">
				...
				<div class="popular__list-item">
					<a href="/catalog/women/super_shuba/" class="popular__list-item-img-wrapper">
                        <img class="popular__list-item-img" src="/upload/iblock/7aa/7aa2d14b9df1c2a4a0eb103fd6ef1da9.jpg" alt="Супер шуба"/>
					...
					<div class="popular__list-item-col category-17">
				<div class="popular__list-item">
					<a href="/catalog/women/slon_obyknovennyy/" class="popular__list-item-img-wrapper">
                        <img class="popular__list-item-img" src="/upload/iblock/47f/47f0732468cafc25a60d58abe736d207.jpg" alt="Слон обыкновенный"/>
                        							<span class="popular__list-item-alert">скидка</span>
						                    </a>
					...
					<div class="popular__list-item-col category-17">
				<div class="popular__list-item">
					<a href="/catalog/women/model_k_51_iz_loskuta_mutona_s_kapyushonom/" class="popular__list-item-img-wrapper">
                        <img class="popular__list-item-img" src="/upload/iblock/1a6/1a6f943c80315712252a6d4fd0ef31cc.jpg" alt="Модель К 51 из лоскута мутона с капюшоном"/>
                        							<span class="popular__list-item-alert">скидка</span>
						                    </a>
				...
				<div class="popular__list-item">
					...
					<div class="popular__list-item-col category-17">
				<div class="popular__list-item">
					<a href="/catalog/women/tsvetnye_korondashi/" class="popular__list-item-img-wrapper">
                        <img class="popular__list-item-img" src="/upload/iblock/c19/c19ef8be1259a060281026046da7fdfe.jpg" alt="Цветные корондаши"/>
				...
				<div class="popular__list-item">
					<a href="/catalog/furskins/shkura_bizona/" class="popular__list-item-img-wrapper">
                        <img class="popular__list-item-img" src="/upload/iblock/011/01169f6d1faaf6e3326572061662b70c.jpg" alt="Шкура бизона"/>
                        							<span class="popular__list-item-alert">новинка</span>
						                    </a>
...
";s:4:"VARS";a:2:{s:8:"arResult";a:0:{}s:18:"templateCachedData";a:1:{s:8:"__NavNum";i:3;}}}';
return true;
?>