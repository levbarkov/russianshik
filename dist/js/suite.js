/**
 * Created by VESPER on 25.08.2014.
 */
/*
 TouchSlider 0.95
...
(function (a, b) {
    window.touchSlider = function (c) {
        ...
        c = a.extend({autoplay: !1, delay: 3e3, margin: 5, viewport: "." + d + "-viewport", prev: "." + d + "-prev", next: "." + d + "-next", pagination: "." + d + "-nav-item", currentClass: d + "-nav-item-current", duration: 350, mouseTouch: !0}, c);
        var f = {current: 0, step: t, next: u, prev: v, start: A, stop: B}, g = "ontouchstart"in window && "WebKitCSSMatrix"in window, h = "touchstart", i = "touchmove", j = "touchend", k = a(c.viewport, e), l = c.scroller ? a(c.scroller, e) : k.children(), m = l.children(), n = a(c.pagination, e);
        ...
        var p = g ? function (a, c, d) {
            ...
            a.css({webkitTransitionDuration: d ? d + "ms" : "0", webkitTransform: function (a) {
        ...
        g && m.css({webkitTransitionProperty: "-webkit-transform", webkitTransitionTimingFunction: "cubic-bezier(0,0,0.25,1)"}), p(m.not(m[0]), 1e4), p(m.eq(0), 0);
        var q = function () {
            var d = [0], e = [0], h = a.noop;
            return{moving: !1, init: function () {
                ...
                if (o !== -1)r = e[o]; else {
                    ...
                    if (o === 0)r = e[1] - (n.outerWidth() + c.margin), p(n, r), e[o] = r; else if (o === d.length - 1)r = e[o - 1] + m.eq(d[o - 1]).outerWidth() + c.margin, p(n, r), e[o] = r; else {
                        ...
                        for (t = 0; t < x; t++)m.eq(d[t]).animate({left: e[t]}, {duration: k, queue: !1, complete: function () {
                ...
                }, g ? p(l, -r, k) : l.animate({left: -r}, {duration: k, queue: !1, complete: h}), f.current = i, s(i)
            }, stop: function () {
                g ? p(l, p(l)) : l.stop()
